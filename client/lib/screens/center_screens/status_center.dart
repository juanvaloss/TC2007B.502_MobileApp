...
class _StatusCenterState extends State<StatusCenter> {
      ...
      items.add(Column(
        children: [
          Container(
            ...
            child: const Icon(FontAwesomeIcons.drumstickBite,
      ...
      items.add(Column(
        children: [
          Container(
            ...
            padding: const EdgeInsets.all(10),
            child: const Icon(FontAwesomeIcons.carrot,
                color: Colors.white, size: 25),
          ),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Información de tu centro de acopio',
      ...
      body: Padding(
          ...
          child: Center(
            ...
            Text('${centerInfo['centerName'] ?? 'No disponible'}',
                style:
                  ...
                  child: Column(
                    children: [
                      ...
                      Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          Text('${result.round()} % lleno',
                              style: const TextStyle(
                                  fontSize: 22, fontWeight: FontWeight.bold)),
                          const SizedBox(width: 20),
                          Text(
                              '${centerInfo['currentCapacity'] ?? -1} / ${centerInfo['totalCapacity'] ?? -1} Kg',
                      ...
                      const SizedBox(height: 10),
                      Text('${centerInfo['centerAddress'] ?? 'No disponible'}',
